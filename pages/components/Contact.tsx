  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden before:absolute before:left-0 before:right-0 before:top-0 before:bottom-0 before:height-full before:bg-[rgba(0,0,0,0.6)] bg-[url('/athens.jpeg')] bg-cover object-cover bg-center flex justify-center items-center z-0 ">
      ...
      <div className="relative h-full w-3/4 text-white z-10 md:h-2/4 lg:h-3/4 flex flex-col md:flex-row items-center">
        <div className="relative w-full p-5 md:w-3/4 h-full md:h-full flex items-center justify-end md:justify-center flex-col md:pl-16 md:items-start">
        ...
        <div className="relative h-0.5 w-3/4 md:h-3/4 md:w-0.5 border border-slate-200 shadow-lg"></div>
        <div className="relative flex justify-center p-10 md:w-3/4 md:h-1/2 md:mt-0 md:flex md:items-start md:justify-evenly md:flex-col md:pl-10">
          <Form />
        </div>
      </div>
    </div>
